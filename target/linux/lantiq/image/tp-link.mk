...
define Device/tplink_tdw8970
  ...
  TPLINK_HWREV := 1
  IMAGE_SIZE := 7680k
  DEVICE_PACKAGES:= kmod-ath9k wpad-basic-wolfssl kmod-usb-dwc2 kmod-usb-ledtrig-usbport dsl-vrx200-firmware-xdsl-a dsl-vrx200-firmware-xdsl-b-patch
...
define Device/tplink_vr200
  ...
  TPLINK_HWREV := 0x53
  IMAGE_SIZE := 15808k
  DEVICE_PACKAGES:= kmod-mt76x0e wpad-basic-wolfssl kmod-usb-dwc2 kmod-usb-ledtrig-usbport dsl-vrx200-firmware-xdsl-a dsl-vrx200-firmware-xdsl-b-patch
...
define Device/tplink_vr200v
  ...
  TPLINK_HWREV := 0x2f
  IMAGE_SIZE := 15808k
  DEVICE_PACKAGES:= kmod-mt76x0e wpad-basic-wolfssl kmod-usb-dwc2 kmod-usb-ledtrig-usbport kmod-ltq-tapi kmod-ltq-vmmc dsl-vrx200-firmware-xdsl-a dsl-vrx200-firmware-xdsl-b-patch
